...
def render_tp_public(
    ...
    output = {
        ...
        "perspectives": {
            ...
            # Deterministic bracket of every non-cluster actor. Written
            # by `derive_mentioned_actors` (renamed 2026-05-21 from
            # `derive_single_voices`; threshold dropped). Surfaced
            # alongside `position_clusters` so consumers can distinguish
            # the bracket (disparate positions deterministically grouped)
