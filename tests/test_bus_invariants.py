...
def test_topicbus_slot_count_regression_guard():
    ...
    Expected: 36 slots across 11 phases.
    ...
    4B.4c=2 (canonical_actors, actor_alias_mapping — Phase 1 of
    TASK-RESOLVE-ACTOR-ALIASES), 4B.4d=3 (canonical_actors_stated /
    ...
    """
    assert len(TopicBus.model_fields) == 36
