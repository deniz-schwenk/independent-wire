...
| `agents/researcher/PLAN-SYSTEM.md` + `PLAN-INSTRUCTIONS.md` | `researcher_plan` | `ResearcherPlanStage` (topic-stage) | `anthropic/claude-opus-4.6` | 0.5 | `none` | 32000 | `tools=[]`. Emits multilingual search query plan. Schema: `RESEARCHER_PLAN_SCHEMA`. |
